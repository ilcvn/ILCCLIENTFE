          ...
          {data.map((member, index) => {
            ...
            return (
              <div
                key={member.id}
                className={clsx(
                  "relative w-[46%] h-auto sm:w-[48%] md:w-[31%] xl:w-[23%] xl:h-[400px] group cursor-pointer bg-white shadow-lg border-dashed border-[2px] border-brandPrimary overflow-hidden hover:border-white rounded-none"
